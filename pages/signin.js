      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "24px 16px 64px" }}>
        <div style={{ width: "100%", maxWidth: "420px" }}>
          ...
          <div style={{
            ...
            <h1 className="si-display" style={{
              margin: "0 0 6px", textAlign: "center",
              fontSize: "26px", fontWeight: 800,
              color: "#1a0533", letterSpacing: "-0.04em",
            }}>
              Welcome back
            </h1>
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <button type="button" onClick={() => setShowPassword(!showPassword)} style={{
                    ...
                    background: "none", border: "none", cursor: "pointer", padding: 0, color: "#c4b5fd",
                  }}>
                    {showPassword
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              ...
              <button className="si-social-btn" style={{ background: "#fff", color: "#374151", border: "1.5px solid rgba(124,58,237,0.15)" }}
